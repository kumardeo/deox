...
export class Base64 {
	...
	static readonly WITH_KEY_1 = new Base64(
		'FINEUiBYDevSagARlwXVuCGzbdjMHQcnKypsZhoWLxfkOmrTPtJq3508749216+/=',
	);

	/** Instance with yet another key variant used for encoding and decoding. */
	static readonly WITH_KEY_2 = new Base64(
		'MBDRTNFJCAPOSQEIGWLHVYZUKXmbdrtnfjcaposqeigwlhvyzukx3508749216+/=',
	);
