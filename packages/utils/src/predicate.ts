 ...
 */
export const getStringTag = (input: any): string =>
 ...
 * @param input The value to check.
 */
export const isFunction = (input: any): input is (..._args: any[]) => any =>
 ...
 * @param input The value to check.
 */
export const isBigInt = (input: any): input is bigint =>
	typeof input === 'bigint';
...
export const isPrimitive = (
	input: unknown,
): input is null | undefined | string | number | boolean | symbol | bigint =>
...
export const isNaN = (input: any) =>
	Number.isNaN
		? Number.isNaN(input)
		: isNumber(input) && getGlobalObject().isNaN(input);
...
export const isFinite = (input: any): input is number =>
	Number.isFinite
		...
		: isNumber(input) && getGlobalObject().isFinite(input);
 ...
 * @param input The value to check.
 */
export const isValidNumber = (input: any): input is number =>
	isNumber(input) && !isNaN(input) && isFinite(input);
 ...
 * @param input The value to check.
 */
export const isSafeNumber = (input: any): input is number =>
	isNumber(input) &&
 ...
 * @param input The value to check.
 */
export const isLength = (input: any): input is number =>
	isNumber(input) && input >= 0 && Number.isSafeInteger(input);
 ...
 * @param input The value to check.
 */
export const isArray = (input: any): input is any[] =>
	Array.isArray ? Array.isArray(input) : getStringTag(input) === 'Array';
...
export const isArrayLike = (input: any): input is ArrayLike<any> =>
	input != null &&
	!isFunction(input) &&
	isLength((input as ArrayLike<unknown>).length);
 ...
 * @param input The value to check.
 */
export const isObjectLike = (input: any): input is object =>
 ...
 * @param input The value to check.
 */
export const isObject = (input: any): input is NonNullable<object> =>
	isObjectLike(input) && !isArray(input);
 ...
 */
export const isArguments = (input: any): input is IArguments =>
	isObjectLike(input) && getStringTag(input) === 'Arguments';
 ...
 * @param input The value to check
 */
export const isURL = (input: any): input is URL =>
...
export const isError = (input: any): input is Error =>
	typeof Error !== 'undefined' && input instanceof Error;
